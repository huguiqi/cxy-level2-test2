<template>
  <div class="home">
    ...
    <el-dialog :visible="visibleAdd">
      <el-form>
        <el-form-item>
          <el-input v-model="addForm.id" placeholder="部门编号"></el-input>
          <el-input v-model="addForm.manager" placeholder="部门经理"></el-input>
          <el-input v-model="addForm.name" placeholder="部门名字"></el-input>
    ...
    <el-dialog :visible="visibleEdit">
      <el-form :inline="false">
        <el-form-item>
          <el-input v-model="editForm.id" disabled placeholder="部门编号"></el-input>
          <el-input v-model="editForm.manager" placeholder="部门经理"></el-input>
          <el-input v-model="editForm.name" placeholder="部门名字"></el-input>
...
export default {
  ...
  data() {
    return {
      queryForm: { "id": "", "name": "", "manager": "" },
      addForm: { "id": "", "name": "", "manager": "","operate":"add" },
      editForm: { "id": "", "name": "", "manager": "","operate":"edit" },
      page: { "total": 20, "pageSize": 5, "pageNum": 1 },
      delIds: "",
      visibleAdd: false,
      visibleEdit: false,
      tableData: [
        { "id": "11", "name": "工程部", "manager": "王二狗" },
        { "id": "12", "name": "工程部", "manager": "王大狗" },
        { "id": "13", "name": "销售部", "manager": "王三狗" },
        { "id": "14", "name": "销售部", "manager": "王四狗" },
        { "id": "15", "name": "技术部", "manager": "王五狗" },
        { "id": "16", "name": "技术部", "manager": "王六狗" }
      ]
    }
  },
  methods: {
